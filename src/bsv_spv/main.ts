...
const port = 5251 // Server that new blocks and mempool txs are announced on
...
const config = {
    ...
    blockHeight: -10, // Sync to block height. 0 to sync to genesis. Negative ti sync to X blocks from current height after 2 hours
